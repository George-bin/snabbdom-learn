...
var hasSvgClassList = 'classList' in SVGElement.prototype;
var patch = init([
    classModule,
    propsModule,
...
describe('snabbdom', function () {
    ...
    describe('created element', function () {
        ...
        it('has different tag and id', function () {
            ...
            var patched = patch(elm, vnode1).elm;
        ...
        it('can create an element created inside an iframe', function (done) {
            ...
            if (typeof frame.srcdoc !== 'undefined') {
                ...
                frame.onload = function () {
                    var div0 = frame.contentDocument.body.querySelector('div');
                    patch(div0, h('div', 'Thing 2'));
                    var div1 = frame.contentDocument.body.querySelector('div');
    ...
    describe('patching an element', function () {
        ...
        describe('using toVNode()', function () {
            ...
            it('can work with domApi', function () {
                var domApi = __assign(__assign({}, htmlDomApi), { tagName: function (elm) { return 'x-' + elm.tagName.toUpperCase(); } });
                var h2 = document.createElement('h2');
                h2.id = 'hx';
            ...
            it('handles random shuffles', function () {
                ...
                for (n = 0; n < samples; ++n) {
                    ...
                    for (i = 0; i < elms; ++i) {
                        ...
                        var opacity = elm.children[i].style.opacity;
    ...
    describe('hooks', function () {
        describe('element hooks', function () {
            ...
            it('calls `prepatch` listener', function () {
                var result = [];
                var cb = function (oldVnode, vnode) {
            ...
            it('calls `init` and `prepatch` listeners on root', function () {
                ...
                var prepatch = function (oldVnode, vnode) {
